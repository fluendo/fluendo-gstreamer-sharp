...
namespace Gst {
	...
	partial class Element {
		...
		public static void AddPadTemplate (GType gtype, PadTemplate templ)
		{
			gst_element_class_add_pad_template (gtype.GetClassPtr (), templ == null ? IntPtr.Zero : templ.OwnedHandle);
		}

		[DllImport ("gstreamer-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern void gst_element_class_add_static_pad_template (IntPtr klass, IntPtr templ);

		public static void AddStaticPadTemplate (GType gType, StaticPadTemplate templ)
		{
			IntPtr templ_as_native = Marshal.AllocHGlobal (Marshal.SizeOf (templ));
			Marshal.StructureToPtr (templ, templ_as_native, false);
			gst_element_class_add_static_pad_template (gType.GetClassPtr (), templ_as_native);
		}
		...
		[DllImport ("gstreamer-1.0-0.dll", CallingConvention = CallingConvention.Cdecl)]
		static extern void gst_element_set_context (IntPtr raw, Context context);

		public void SetContext (Context context)
		{
			gst_element_set_context (Handle, context);
		}
	}
}
