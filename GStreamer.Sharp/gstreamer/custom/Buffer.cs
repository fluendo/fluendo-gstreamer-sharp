...
namespace Gst {
	...
	partial class Buffer {
		...
		static extern IntPtr gst_buffer_get_gl_sync_meta (IntPtr raw, IntPtr context);

		public GLSyncMeta GLSyncMeta {
			get {
				IntPtr raw_ret = gst_buffer_get_meta (Handle, GL.Global.GlSyncMetaApiGetType ().Val);
				return GLSyncMeta.New (raw_ret);
			}
		}
	}
}
