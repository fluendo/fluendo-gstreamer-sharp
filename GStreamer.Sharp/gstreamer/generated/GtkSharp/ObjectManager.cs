...
namespace GtkSharp.GstreamerSharp {
	...
	public class ObjectManager {
		...
		public static void Initialize ()
		{
			...
			GLib.GType.Register (Gst.GL.GLBaseFilter.GType, typeof (Gst.GL.GLBaseFilter));
			GLib.GType.Register (Gst.GL.GLBaseMemoryAllocator.GType, typeof (Gst.GL.GLBaseMemoryAllocator));
			GLib.GType.Register (Gst.GL.GLBaseSrc.GType, typeof (Gst.GL.GLBaseSrc));
			GLib.GType.Register (Gst.GL.GLBufferAllocator.GType, typeof (Gst.GL.GLBufferAllocator));
			GLib.GType.Register (Gst.GL.GLBufferPool.GType, typeof (Gst.GL.GLBufferPool));
			GLib.GType.Register (Gst.GL.GLColorConvert.GType, typeof (Gst.GL.GLColorConvert));
			GLib.GType.Register (Gst.GL.GLContext.GType, typeof (Gst.GL.GLContext));
			GLib.GType.Register (Gst.GL.GLDisplay.GType, typeof (Gst.GL.GLDisplay));
			GLib.GType.Register (Gst.GL.GLFilter.GType, typeof (Gst.GL.GLFilter));
			GLib.GType.Register (Gst.GL.GLFramebuffer.GType, typeof (Gst.GL.GLFramebuffer));
			GLib.GType.Register (Gst.GL.GLMemoryAllocator.GType, typeof (Gst.GL.GLMemoryAllocator));
			GLib.GType.Register (Gst.GL.GLMemoryPBOAllocator.GType, typeof (Gst.GL.GLMemoryPBOAllocator));
			GLib.GType.Register (Gst.GL.GLOverlayCompositor.GType, typeof (Gst.GL.GLOverlayCompositor));
			GLib.GType.Register (Gst.GL.GLRenderbufferAllocator.GType, typeof (Gst.GL.GLRenderbufferAllocator));
			GLib.GType.Register (Gst.GL.GLSLStage.GType, typeof (Gst.GL.GLSLStage));
			GLib.GType.Register (Gst.GL.GLShader.GType, typeof (Gst.GL.GLShader));
			GLib.GType.Register (Gst.GL.GLUpload.GType, typeof (Gst.GL.GLUpload));
			GLib.GType.Register (Gst.GL.GLViewConvert.GType, typeof (Gst.GL.GLViewConvert));
			GLib.GType.Register (Gst.GL.GLWindow.GType, typeof (Gst.GL.GLWindow));
		}
	}
}
